  ...
  return (
    <div className="flex flex-col items-center justify-center my-8">
      <div className="relative w-20 h-20">
        <div className="absolute inset-0 m-auto w-16 h-16 border-4 border-dashed rounded-full border-blue-400 animate-spin"></div>
        <div className="absolute inset-0 m-auto w-20 h-20 border-4 border-t-4 border-blue-500 rounded-full animate-spin" style={{ animationDuration: '1.5s' }}></div>
      </div>
